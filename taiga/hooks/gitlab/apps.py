# -*- coding: utf-8 -*-
# Copyright (C) 2014-2020 Andrey Antukh <niwi@niwi.nz>
# Copyright (C) 2014-2020 Jesús Espino <jespinog@gmail.com>
# Copyright (C) 2014-2020 David Barragán <bameda@dbarragan.com>
# Copyright (C) 2014-2020 Alejandro Alonso <alejandro.alonso@kaleidos.net>
...
def _connect_all_signals():
    ...
    issue_status_post_move_on_destroy_signal.connect(handle_move_on_destroy_issue_status,
                                                     ...
                                                     dispatch_uid="move_on_destroy_issue_status")
