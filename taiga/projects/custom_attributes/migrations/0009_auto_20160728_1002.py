    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('epic', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='custom_attributes_values', to='epics.Epic', verbose_name='epic', on_delete=models.CASCADE)),
            ],
            options={
                'abstract': False,
