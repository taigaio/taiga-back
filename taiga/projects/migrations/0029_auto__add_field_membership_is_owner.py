...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.is_owner'
        db.add_column('projects_membership', 'is_owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.is_owner'
        db.delete_column('projects_membership', 'is_owner')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'creation_template': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'projects'", 'null': 'True', 'to': "orm['projects.ProjectTemplate']", 'blank': 'True'}),
            'default_issue_status': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'related_name': "'+'", 'unique': 'True', 'to': "orm['projects.IssueStatus']"}),
            'default_issue_type': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'related_name': "'+'", 'unique': 'True', 'to': "orm['projects.IssueType']"}),
            'default_points': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'related_name': "'+'", 'unique': 'True', 'to': "orm['projects.Points']"}),
            'default_priority': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'related_name': "'+'", 'unique': 'True', 'to': "orm['projects.Priority']"}),
            'default_severity': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'related_name': "'+'", 'unique': 'True', 'to': "orm['projects.Severity']"}),
            'default_task_status': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'related_name': "'+'", 'unique': 'True', 'to': "orm['projects.TaskStatus']"}),
            'default_us_status': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'related_name': "'+'", 'unique': 'True', 'to': "orm['projects.UserStoryStatus']"}),
        ...
        'users.user': {
            ...
            'color': ('django.db.models.fields.CharField', [], {'max_length': '9', 'default': "'#21c908'", 'blank': 'True'}),
