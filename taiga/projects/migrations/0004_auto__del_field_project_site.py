...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('projects_project', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, related_name='+', default=None, to=orm['domains.Domain']),
                      keep_default=False)
    ...
    models = {
        ...
        'projects.membership': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'null': 'True', 'unique': 'True', 'default': 'None', 'max_length': '60', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'default': 'None', 'related_name': "'memberships'", 'to': "orm['users.User']"})
        },
        'projects.points': {
        ...
        'projects.project': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'default_issue_status': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'to': "orm['projects.IssueStatus']", 'null': 'True', 'unique': 'True', 'blank': 'True'}),
            'default_issue_type': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'to': "orm['projects.IssueType']", 'null': 'True', 'unique': 'True', 'blank': 'True'}),
            'default_points': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'to': "orm['projects.Points']", 'null': 'True', 'unique': 'True', 'blank': 'True'}),
            'default_priority': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'to': "orm['projects.Priority']", 'null': 'True', 'unique': 'True', 'blank': 'True'}),
            'default_question_status': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'to': "orm['projects.QuestionStatus']", 'null': 'True', 'unique': 'True', 'blank': 'True'}),
            'default_severity': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'to': "orm['projects.Severity']", 'null': 'True', 'unique': 'True', 'blank': 'True'}),
            'default_task_status': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'to': "orm['projects.TaskStatus']", 'null': 'True', 'unique': 'True', 'blank': 'True'}),
            'default_us_status': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'to': "orm['projects.UserStoryStatus']", 'null': 'True', 'unique': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'projects'", 'default': 'None', 'to': "orm['domains.Domain']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
