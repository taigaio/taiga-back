...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.videoconferences_salt'
        db.add_column('projects_project', 'videoconferences_salt',
                      self.gf('django.db.models.fields.CharField')(blank=True, null=True, max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.videoconferences_salt'
        db.delete_column('projects_project', 'videoconferences_salt')
    ...
    models = {
        ...
        'projects.membership': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'blank': 'True', 'related_name': "'memberships'", 'null': 'True', 'default': 'None'})
        },
        'projects.points': {
        ...
        'projects.project': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'default_issue_status': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['projects.IssueStatus']", 'blank': 'True', 'related_name': "'+'", 'unique': 'True', 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            'default_issue_type': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['projects.IssueType']", 'blank': 'True', 'related_name': "'+'", 'unique': 'True', 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            'default_points': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['projects.Points']", 'blank': 'True', 'related_name': "'+'", 'unique': 'True', 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            'default_priority': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['projects.Priority']", 'blank': 'True', 'related_name': "'+'", 'unique': 'True', 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            'default_question_status': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['projects.QuestionStatus']", 'blank': 'True', 'related_name': "'+'", 'unique': 'True', 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            'default_severity': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['projects.Severity']", 'blank': 'True', 'related_name': "'+'", 'unique': 'True', 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            'default_task_status': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['projects.TaskStatus']", 'blank': 'True', 'related_name': "'+'", 'unique': 'True', 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            'default_us_status': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['projects.UserStoryStatus']", 'blank': 'True', 'related_name': "'+'", 'unique': 'True', 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['domains.Domain']", 'blank': 'True', 'related_name': "'projects'", 'null': 'True', 'default': 'None'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
