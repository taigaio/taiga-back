...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'projects.membership': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'memberships'", 'default': 'None', 'to': "orm['users.User']", 'null': 'True', 'blank': 'True'})
        },
        'projects.points': {
        ...
        'projects.project': {
            ...
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'projects'", 'default': 'None', 'to': "orm['domains.Domain']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
